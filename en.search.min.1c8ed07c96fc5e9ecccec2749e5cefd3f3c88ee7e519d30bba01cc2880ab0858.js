...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6e4e548e4ef92359f34b9fb16be8cafde2ae60c7eed23d96b9dc66fdaf55de55.js',function(){input.required=false;search();});}
