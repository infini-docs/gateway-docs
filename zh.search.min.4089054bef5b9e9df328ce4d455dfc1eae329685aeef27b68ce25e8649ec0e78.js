...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.97a9ff1b6fcbd3a05ac51d7b588d0263448db7b84d817ab67a91b4a4b0e515dc.js',function(){input.required=false;search();});}
