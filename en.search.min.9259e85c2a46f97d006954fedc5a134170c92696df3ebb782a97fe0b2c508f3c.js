...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6691895d07fc837ae07a7f59b6638ea90c3da2e9d26a2fd4b91f937ecfad2fcb.js',function(){input.required=false;search();});}
