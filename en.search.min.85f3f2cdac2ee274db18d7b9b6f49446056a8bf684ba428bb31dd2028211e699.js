...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.367e6f7fad33c9185095778525ed66a00b77a7d6c8956d0ae5e5e5e60bba070c.js',function(){input.required=false;search();});}
