...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.6.0/flexsearch.min.js');loadScript('/v1.6.0/zh.search-data.min.e65b696d88cdc3d2cf0e43cd386d50737bcdb2d10566a9f803cc931280ebaec2.js',function(){input.required=false;search();});}
