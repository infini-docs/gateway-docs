...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.8.0/flexsearch.min.js');loadScript('/v1.8.0/en.search-data.min.d7af493b1e3720709af98c0ddeb7d27d629fbcda641485e297c368d4a15101b6.js',function(){input.required=false;search();});}
