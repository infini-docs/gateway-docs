...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.fa7e5bddd426f87e7a0a5e2186153d9f97a6d5891a3629e93fb1c087386e828d.js',function(){input.required=false;search();});}
