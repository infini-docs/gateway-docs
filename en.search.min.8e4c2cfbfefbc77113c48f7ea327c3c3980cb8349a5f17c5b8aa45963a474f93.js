...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8a0139adf81f03e3ea212fdbef2088a2e76f8d8204000501d3a1f486a7c92934.js',function(){input.required=false;search();});}
