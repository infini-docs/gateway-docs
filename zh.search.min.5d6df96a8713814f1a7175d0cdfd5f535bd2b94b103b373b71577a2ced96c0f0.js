...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.8f65da05452e43afeec37d85072df308e4faa7cd6bd90012d9d83f0a098aceca.js',function(){input.required=false;search();});}
