...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.93c3759cf200cabe49e34f66da245ac801d4bd933e2303a8cfebcf1fdb4a17c1.js',function(){input.required=false;search();});}
