...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ebd63a24baa9a8eadce9d02693e402a2a83f442cca49243a53a24ef3da58107d.js',function(){input.required=false;search();});}
