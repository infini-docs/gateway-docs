...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.468762856b40528f681a6ae1c6069b79da615e2205479c39bd48dccd43fa3ced.js',function(){input.required=false;search();});}
