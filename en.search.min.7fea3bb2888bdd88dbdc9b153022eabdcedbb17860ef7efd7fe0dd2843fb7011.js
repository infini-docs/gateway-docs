...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.736cf684259b4f5cef52108afb41a8042812ceea63e67c7a2a75811d102706d2.js',function(){input.required=false;search();});}
