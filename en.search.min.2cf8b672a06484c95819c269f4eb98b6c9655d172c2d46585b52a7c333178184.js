...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f3a4cc339e2ce2fc022ad2e5cf81c47a9a6e328b70f687de305f95c95e07aedb.js',function(){input.required=false;search();});}
