...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.193e5436ba62914a7906ddf3379a00e9a483eea5428d66004134c3872aa1a624.js',function(){input.required=false;search();});}
