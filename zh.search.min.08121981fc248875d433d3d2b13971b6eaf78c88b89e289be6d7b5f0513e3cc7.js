...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.75c56bd09508babb580cad0390dd462e0b2707437a48700d7c0489e8d810902e.js',function(){input.required=false;search();});}
