...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.938ec03b9eb88fec0a9b39bffaf27d73894537e1e590acf789586f8326d14804.js',function(){input.required=false;search();});}
