...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3ebcfb6700cd6464b297d6deb4d3a4b9d7c20d1a9770cf4f3da4e04451234f95.js',function(){input.required=false;search();});}
