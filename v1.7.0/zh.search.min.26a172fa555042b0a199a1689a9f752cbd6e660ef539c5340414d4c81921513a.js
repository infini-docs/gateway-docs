...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.7.0/flexsearch.min.js');loadScript('/v1.7.0/zh.search-data.min.90ae3e46215d3bc4ba1c49a03e43248e3b06254ae2df1ae5d5fc3259f7760279.js',function(){input.required=false;search();});}
