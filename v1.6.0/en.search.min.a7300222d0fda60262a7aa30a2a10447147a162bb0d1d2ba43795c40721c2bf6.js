...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.6.0/flexsearch.min.js');loadScript('/v1.6.0/en.search-data.min.1d75d4acc91ad4cf6243b5265c4c1aad2a45e1abfb395ef2327c8ef5274c906a.js',function(){input.required=false;search();});}
