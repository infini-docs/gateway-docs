...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.8.0/flexsearch.min.js');loadScript('/v1.8.0/zh.search-data.min.08e574bc1963c77cc4b5b13c3b9063864e47766165135a9098542ee8c9e8bf51.js',function(){input.required=false;search();});}
