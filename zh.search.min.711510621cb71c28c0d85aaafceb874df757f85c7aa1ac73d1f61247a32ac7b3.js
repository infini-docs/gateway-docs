...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.cad81b62f5fa1a1e015c9d5ee4fc4a33a2bac6a676070f81e2db311087bad28f.js',function(){input.required=false;search();});}
