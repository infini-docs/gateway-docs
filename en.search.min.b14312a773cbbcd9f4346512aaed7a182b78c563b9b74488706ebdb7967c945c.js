...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.be11097a47a545174a9c2d02e1dbcf0fb030388c0397975ff533417b12fca430.js',function(){input.required=false;search();});}
