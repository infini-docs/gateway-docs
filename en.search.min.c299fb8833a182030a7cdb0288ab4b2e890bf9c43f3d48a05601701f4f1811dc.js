...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.95320e7a920eb7a7a0eef0369dd1799efd2e138317be1976b5fe605596a190ba.js',function(){input.required=false;search();});}
