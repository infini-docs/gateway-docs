...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.7.0/flexsearch.min.js');loadScript('/v1.7.0/en.search-data.min.ac2e27ebe32d9abe7eb3cb4f87e59d30fe30968eb110007a47bda1356207e2e0.js',function(){input.required=false;search();});}
