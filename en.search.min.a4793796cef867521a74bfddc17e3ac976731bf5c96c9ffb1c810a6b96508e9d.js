...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e41d17d2a669895bd452e9e2d4b60f0783c7081a6cf87cf46275fbef31b7e53e.js',function(){input.required=false;search();});}
