...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.804e723d0bad2ebc96c2015aa4feb0a7d486ad0dcba6db335156ee0ea36359cb.js',function(){input.required=false;search();});}
