...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.563c1ff94e47a1495e93a72caf4bf32a8b6a3e8fbe4fb5fd83cf4e2869163b99.js',function(){input.required=false;search();});}
